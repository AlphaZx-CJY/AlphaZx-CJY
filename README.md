...
<!-- 副标题 -->
<p align="center">
  <img src="https://img.shields.io/badge/Focus-AI%20Tool%20Chain-58A6FF?style=flat-square" />
  <img src="https://img.shields.io/badge/Location-Shanghai%2C%20China-FF6B6B?style=flat-square" />
  <img src="https://img.shields.io/badge/Motto-Simplify%20Complexity-4ECDC4?style=flat-square" />
</p>

<!-- 地理坐标装饰 -->
<pre>
╔══════════════════════════════════════════╗
║  📍 N31°14' E121°29'  ·  Shanghai, China  ║
╚══════════════════════════════════════════╝
</pre>
...
```
┌─────────────────────────────────────────────────────────────┐
│  2021 - Present    Huawei OD · Shanghai                     │
│                   └─▶ DevEco Studio 亮点特性开发              │
│                       · 低代码平台 - 可视化拖拽式 UI 构建      │
│                       · UI 生成 - Android XML 转鸿蒙页面      │
│                       · 智慧化调优 - AI 分析调优数据          │
│                       · UI 意图识别 - 智能解析设计意图         │
├─────────────────────────────────────────────────────────────┤
│  2019 - 2021       北京华宇软件股份有限公司                  │
│                   └─▶ 语音识别 · 基于 Kaldi + 吉林市人民法院  │
│                   └─▶ 姿态识别 · STGCN + OpenPose 监狱场景    │
├─────────────────────────────────────────────────────────────┤
│  2015 - 2019       杭州电子科技大学 · 软件工程本科             │
└─────────────────────────────────────────────────────────────┘
```
